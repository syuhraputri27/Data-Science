...
scaler_ = pickle.load(open("scaler.pickle", 'rb'))
...
with tab1:
  ...
  if predict_btn:
    ...
    inputs_scaler = scaler_.transform(inputs)
    prediction = model.predict(inputs_scaler)[0]
...
with tab2:
  ...
  if file_uploaded:
    ...
    uploaded_df_scaler = scaler_.transform(uploaded_df)
